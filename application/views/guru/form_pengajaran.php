      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>guru/pengajaran/<?=$url;?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" disabled="disabled" name="materi" class="form-control" value="<?php echo $modul?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                    <input type="text" required="required" name="nilai" class="form-control" value="<?php echo $nilai?>" placeholder="Nilai">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url()?>guru/pengajaran" class="btn btn-default">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
